        ...
        <div className="group relative mb-8"> 
            <div className="h-48 md:h-64 rounded-t-xl overflow-hidden relative">
                ...
                <Image 
                    ...
                    alt={title} />
                <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#111113] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all rounded-t-xl">
